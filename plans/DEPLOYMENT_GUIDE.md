...
- Доступ к домену `https://ваш_домен.ru`
...
```bash
curl -X POST https://ваш_домен.ru/council \
...
- Проверьте, что домен `https://ваш_домен.ru` указывает на правильный IP-адрес
